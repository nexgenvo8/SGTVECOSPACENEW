    ...
    >
      ...
      <Drawer.Screen
        ...
        options={{
          ...
          drawerLabel: "Guest Speakers & Trainers",
        }}
      />
      <Drawer.Screen
      ...
      {/* <Drawer.Screen
        ...
        options={{
          drawerIcon: ({color, size}) => (
            // <IdIcon name="id-card" size={20} color={color} />
            <Icon name="id-card" size={20} color={color} />
          ),
          drawerLabel: 'Job Fair Registration',
        }}
      /> */}
      {/* <Drawer.Screen
        name="TEDxJMI"
      ...
      <Drawer.Screen
        ...
        options={{
          drawerIcon: ({ color, size }) => (
            // <Icon name="contact-page" size={size} color={color} />
...
export default function App() {
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      setIsLoading(false);
    }, 3000); // Show splash for exactly 5 seconds
