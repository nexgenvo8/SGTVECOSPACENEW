      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <Text style={styles.subsection}>
          ...
          <Text style={styles.text}>
            ...
            please contact us at {universityemailId}.
          </Text>
        </Text>
        ...
        <Text style={styles.text}>
          ...
          the rights, property, or safety of, or prevent fraud or abuse of, SGT
          VECOSPACE or others.
        </Text>
        ...
        <Text style={styles.text}>
          ...
          account settings or by sending a request to {universityemailId} as
          described inYou may deactivate your account by editing your account
          settings or by sending an email to {universityemailId}. You will also
          be able to choose what information others see about you and who may
          contact you by using the Privacy Settings section in your Account.
        </Text>
        <Text style={styles.subsection}>
        ...
        <Text style={styles.text}>
          ...
          please contact {universityemailId}.
        </Text>
