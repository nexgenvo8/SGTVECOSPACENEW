...
import { universityemailId, universityName } from "../constants";
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <Text style={styles.text}>
          1. Organizers may establishmembership criteriafor their own SGT
          ...
          you can’t find the right group, you can easily start your own SGT
          VECOSPACE group.
        </Text>
        <Text style={styles.text}>
        ...
        <Text style={styles.text}>
          ...
          violate any rights you may have in your Content, you hereby grant SGT
        ...
        <Text style={styles.text}>
          ...
          and other third-party partners (referred to in this Agreement as “SGT
        ...
        <Text style={styles.text}>
          8.1 Informal Resolution -: Before making any claim, you and SGT
        ...
        <Text style={styles.text}>
          ...
          10.1 The arbitration will be conducted in accordance with SGT
        ...
        <Text style={styles.text}>
          8.6 Class Action Waiver -: You agree to resolve disputes with SGT
        ...
        <Text style={styles.text}>
          ...
          {universityemailId}. Any notice to you shall be given to the most
        ...
        <Text style={styles.text}>
          ...
          member or third party by sending an email to {universityemailId}
        </Text>
        <Text style={styles.text}>
