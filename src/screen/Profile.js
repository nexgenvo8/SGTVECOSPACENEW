      ...
      <View style={globalStyles?.FX_1_BG_White}>
        <ScrollView showsVerticalScrollIndicator={false} style={{ flex: 0.9 }}>
          ...
          {/* <View style={styles.skillMainView}>
            <View style={styles.secongSkillView}>
              <Text style={globalStyles.sectionText}>Languages</Text>
              <PencilIcon
                onPress={() => setModalVisible3()}
                name="plus"
                size={20}
                            ...
                            style={{
                              backgroundColor:
                                selectedValue === 'Basic'
                                  ...
                                  : selectedValue === 'Good'
                                  ? '#9f00a4'
                                  : selectedValue === 'Fluent'
                                  ? '#1fabdb'
                                  : selectedValue === 'First Language'
                                  ? '#b0d400'
                                  : null,
                              width:
                                selectedValue === 'Basic'
              ...
              {interestsValue.length > 0 ? (
                <View style={styles.skillValueMainView}>
                  {interestsValue.map((item, index) => (
                    ...
                    >
                      {/* Check if the item is an object and render its exploringText, otherwise render the string */}
                      <Text
                        style={{ ...styles.skillText, color: colors.textColor }}
                      >
