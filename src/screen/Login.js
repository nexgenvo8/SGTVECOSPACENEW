      ...
      <ScrollView style={{ flex: 1, backgroundColor: colors.background }}>
        <View style={{ flex: 1 }}>
          ...
          >
            <CheckBox
              value={isChecked}
              onValueChange={(newValue) => setIsChecked(newValue)} // Update the state when the checkbox is clicked
              style={{
                transform: [{ scaleX: 0.8 }, { scaleY: 0.8 }], // Increase size by 1.5 times
                // margin: 10,
          ...
          >
            <Text style={{ color: colors.AppmainColor, fontSize: 15 }}>
              Forgot Password?
            </Text>
          </TouchableOpacity>
          <View
